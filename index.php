...
/* Required settings     */
$HCSET['OFFER_PAGE'] = 'offer_link';//PHP/HTML file or URL offer used for real users
$HCSET['WHITE_PAGE'] = 'none';//PHP/HTML file or URL used for bots
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v22138682439&js=false&stage='.$HCSET['stage'];
